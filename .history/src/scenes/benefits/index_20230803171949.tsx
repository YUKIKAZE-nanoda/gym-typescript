                ...
                <div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="mb-5">
                            70 billion parameter open source model by Meta fine-tuned for chat purposes. LLaMA v2 was trained on more data (~2 trillion tokens) compared to LLaMA v1 and supports context windows up to 4k tokens.
                            </p>
                        </div>
                    </div>
                </div>
