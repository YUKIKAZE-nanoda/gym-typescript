            ...
            >
                ...
                <div className="mt-10 justify-between gap-8 md:flex">
                    ...
                    >
                        ...
                        <div className='md:before:content-evolvetext w-full before_absolute before:-bottom-20 before:-right-10 before:z-[-1]'>
                            <img  className='w-full' alt="contact-us-page-graphic" src={Con}/>
                        </div>
