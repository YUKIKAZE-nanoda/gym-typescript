...
const ContactUS = ({ setSelectedPage }: Props) => {
    ...
    const inputStyles = `w-full rounded-lg bg-primary-100 px-5 py-3 placeholder-white`;
                ...
                <div className="mt-10 justify-between gap-8 md:flex">
                    ...
                    >
                        ...
                        >
                            ...
                            <button 
                            type='submit'
                            className='mt-5 rounded-lg bg-secondary-500 px-20 py-3 transition duration-500 hover:text '/>
                        </form>
                    </motion.div>
